...
insert into nk2_discount_codes (code, production_id, eur, use_max, email, code_group) values
    ('TEST_123', 2, '14', 1, 'foo@example.com', 'TEST'),
    ('admin-code', 3, 99, 9999, 'bar@example.com', 'ADMIN');
